    ...
    <div class="select-container">
        <form method="GET" action="administrateur.php">
            <select name="role" class="select-box"  >
                <option value="tous" <?php if ($filtre == "tous") echo "selected"; ?>>Tous</option> <!-- permet donc de prendre le role apres le filtrage et comparer avec celui de la selection et donc si oui, le marque comme celui selectionner  -->
                <option value="client" <?php if ($filtre == "client") echo "selected"; ?>>Clients</option>
                <option value="administrateur" <?php if ($filtre == "administrateur") echo "selected"; ?>>Administrateurs</option>
                <option value="livreur" <?php if ($filtre == "livreur") echo "selected"; ?>>Livreurs</option>
                <option value="restaurateur" <?php if ($filtre == "restaurateur") echo "selected"; ?>>Restaurateurs</option>
            </select>
